...
namespace Preventorium
{
    public partial class delete : Form
    {
        ...
        {
            switch(table)//выбор таблицы в зависимости от значени переменной table
            {
                case "Queue":
                ...
                case "Cards":
                    ...
                    break;
                case "Users":
                    string result6 = Program.add_read_module.del_record_by_id("Users", "IDUsers", Convert.ToInt32(this._id));
                    if (result6 == "OK")
                    {
                        this.Dispose();
                    }
